...
use App\User;
$checkuserfriend =   DB::table('alert_friend')
                ->where([
...
if($users == '[]'){ ?>
  <div class="panel panel-default" style=" border:0px; background-color:#111;">
    <div class="panel-body" style="background-color:#111; border:0px;"  align="center">
      ...
      <h1 style="color:#999;">{{ $UserView->name }} no status!</h1>
    </div>
  </div>
<?php
}else{
 ...
 ?>
  ...
  <div class="panel panel-default border-radiusbox" id="{{ $yourstatus->id }}">
      <div class="panel-heading border-radius-top-20px2" style="background-color:#cc9900;">
        <div class="" style="position:absolute; right:20px;">
            ...
            <?php
             ...
             ?>
             @if($UserView->id == Auth::user()->id)
              <ul class="dropdown-menu dropdown-menu-right" style="background-color:#888;">
                @if($yourstatus->type != 'text')
                <li><a href="#" onclick="editport( '{{ $yourstatus->id }}' ,'{{ $yourstatus->status }}' ,'{{ asset($yourstatus->path) }}' ,'{{ $typefile }}')"><i class="glyphicon glyphicon-cog"></i> Edit</a></li>
                @else
          ...
          <a href="{{ url('/home') }}" class="btnMenulife" style="color:#000;">
            <img class="img-circle" style="{{ $UserView->filter }}" src="{{ asset(''.$UserView->avatar)  }}" width="60px">
            <label for="" style="font-size:18px;">{{ $UserView->name }}</label>
          </a>
      ...
      <div class="panel-body">
          <label for="" style="font-size:15px; color:#fff;"><?php print $yourstatus->status; ?></label>
          @if($yourstatus->type != 'text')
                      ...
                      <div class="panel-body">
                        <a href="{{ asset($yourstatus->path) }}" class="btnMenulife">
                          <div class="col-md-4" style="border-right: 2px solid #222;">
                            <img src="{{ asset('\icon\preview_pdf.png') }}" alt="" width="100%">
                          </div>
                          <div class="col-md-8" >
                  ...
                  <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default" style="background-color:#333; border-color:#222;">
                      <div class="panel-body">
                        <a href="{{ asset($yourstatus->path) }}" class="btnMenulife">
                          <div class="col-md-4" style="border-right: 2px solid #222;">
                            <img src="{{ asset('\icon\preview_doc.png') }}" alt="" width="100%">
                          </div>
                          <div class="col-md-8" >
                            <button type="button" class="btnview" style="background-color:#444; ">
                              {{ $namefile }}
                  ...
                  <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default" style="background-color:#333; border-color:#222;">
                      <div class="panel-body">
                        <a href="{{ asset($yourstatus->path) }}" class="btnMenulife">
                          <div class="col-md-4" style="border-right: 2px solid #222;">
                            <img src="{{ asset('\icon\preview_pp.png') }}" alt="" width="100%">
                          </div>
                          <div class="col-md-8" >
                            <button type="button" class="btnview" style="background-color:#444; ">
                              {{ $namefile }}
                  ...
                  <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default" style="background-color:#333; border-color:#222;">
                      <div class="panel-body">
                        <a href="{{ asset($yourstatus->path) }}" class="btnMenulife">
                          <div class="col-md-4" style="border-right: 2px solid #222;">
                            <img src=" {{ asset('\icon\preview_excel.png' )}}" alt="" width="100%">
                          </div>
                          <div class="col-md-8" >
                            <button type="button" class="btnview" style="background-color:#444; ">
                              {{ $namefile }}
                  ...
                  <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default" style="background-color:#333; border-color:#222;">
                      <div class="panel-body">
                        <a href="{{ asset($yourstatus->path) }}" class="btnMenulife">
                          <div class="col-md-4" style="border-right: 2px solid #222;">
                            <img src="{{ asset('\icon\preview_file.png') }}" alt="" width="100%">
                          </div>
                          <div class="col-md-8" >
                            <button type="button" class="btnview" style="background-color:#444; ">
                              {{ $namefile }}
