...
<div class="container-fluid" style="background-color:#111; margin-left:-0px;" >
  <div class="col-md-3" id="menubarleft" style=" margin-left:-25px;" >
    ...
    <div class="panel panel-default" style="border-radius-: 20px; background-color:#111; border-color:#111;">
        ...
        $DetailProfile = DetailProfile::find(Auth::user()->id );
        ...
        <div class="col-md-3">
          <div class="panel panel-default" style="width:122%; border-radius:0px;  margin:0px; border-color:#888;">
              <div class="panel-heading" style=" width:100%; border-color:#888; margin:0px; padding:0px;" >
                  <img src="{{ Auth::user()->cover }}" width="100%" height="350px" alt="" style="margin:0px; object-fit: cover;">
                ...
                <div class="panel-body" style="background-color:#555; width:100%;">
                  <div class="panel-body" style="width:100%; background-color:#555; color:#fff;padding:10px 30px 30px 30px;">
                    <h3>About me</h3>
                    <table class="table">
                      <tbody>
                        <tr>
                          <td style="width:160px; border-color:#777;"><i class="glyphicon glyphicon-user"></i> Name</td>
                          <td style="border-color:#777;"> {{ Auth::user()->name }}</td>
                        </tr>
                        <tr>
                          <td style="width:160px; border-color:#777;"><i class="glyphicon glyphicon-envelope"></i> Email</td>
                          <td style="border-color:#777;"> {{ Auth::user()->email }}</td>
                        </tr>
                        @if($DetailProfile != '')
                          <tr>
                    ...
                    <p align="center">
                      <a href="{{ url('settings/editprofile') }}" style="color:#fff;"> You can edit profile and add your topic. <i class="glyphicon glyphicon-pencil"></i></a>
                    </p>
                      <hr style="width:50%;">
                      <center>
                        <a href="{{ url('portfolio') }}" class="btn btn-primary btn-lg btn-lg btnprofolio">
