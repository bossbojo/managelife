  ...
  <div>
   ...
   <form class="" action="{{ url('EditQuestion') }}" method="post">
    <div class="col-md-12" style="background-color:#333; padding:10px; color:#aaa;">
      <h4 style="color:#aaa;"><b>Edit question</b></h4>
      ...
      <div class="" align="">
        <div class="col-md-8 col-md-offset-2">
          ...
          <div class="col-md-10" align="">
            {{ csrf_field() }}
            <input type="text" class="form-control" name="topic" id="topic" value="{{ $Q->topic }}">
            <input type="hidden" class="form-control" name="Id" id="Id" value="{{ $Q->id }}">
          </div>
          <br>
          <hr>
        </div>
        <div class="" >
          <textarea name="question" id="question" style="width:100%; height: 800px;" style=" background-color:#aaa;" placeholder="">
            <?php
            print $Q->questioned;
             ?>
          </textarea>
