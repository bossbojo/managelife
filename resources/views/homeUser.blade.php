                ...
                <div class="col-md-9" style="padding:10px;">
                  <form class="PostStatus" id="PostStatus">
                    ...
                    <a  id="shotcutBtnfile" href="#" class="btn btn-default" >
                     <img src="{{ asset('public/icon/camera.png') }}" width="20px"> image |
                     <img src="{{ asset('public/icon/video.png') }}" width="20px"> video |
                     <img src="{{ asset('public/icon/audio.png') }}" width="15px"> audio |
                     <img src="{{ asset('public/icon/blank-file-xxl.png') }}" width="15px"> file
                    </a>
      ...
      var save_editposturl_file = "{{ url('/save_editposturl_file') }}";
       $('#save_editposturl_file').ajaxForm({
         ...
         error: function(xhr,textStatus){ alert(textStatus);}
              ...
              setTimeout(function(){ loadpage(); }, 1000);
              function loadpage() {
                $( ".result" ).load( "{{ url('showstatusUser') }}"+"/{{ $UserView->id }}" );
              }
                ...
                <div class="panel-heading" style=" width:100%; border-color:#888; margin:0px; padding:0px;" >
                  ...
                  <div class="center" align="center">
                   ...
                   <div class="topleft">
                     ...
                     <a href="#" id="CancelAddFriend" class="btn btn-default" style="display:none;" onclick="CancelAddFriend('{{ Auth::user()->id }}','{{ $UserView->id }}')"><i class="glyphicon glyphicon-option-horizontal"></i> Requesting Add friend</a>
                     @endif
                     @if($statusfriend != null)
                       @if($statusfriend->status_alert =='requesting')
                          ...
                          @else
                            <a href="#" id="Addfriend" class="btn btn-default" style="display:none;" onclick="addfriend('{{ Auth::user()->id }}','{{ $UserView->id }}')"><i class="glyphicon glyphicon-plus"></i> Add friend</a>
                            <a href="#" id="CancelAddFriend" class="btn btn-default" style="display:;" onclick="CancelAddFriend('{{ Auth::user()->id }}','{{ $UserView->id }}')"><i class="glyphicon glyphicon-option-horizontal"></i> Requesting Add friend</a>
                          @endif
                       @endif
                       @if($statusfriend->status_alert == 'friend')
                       <a href="#" id="RemoveFriend" class="btn btn-default" style="display:;" onclick="RemoveFriend('{{ Auth::user()->id }}','{{ $UserView->id }}')"><i class="glyphicon glyphicon-option-horizontal"></i> Remove friend</a>
                       @endif
                    @endif
                    <a href="#" id="CancelAddFriend" class="btn btn-default" style="display:none;" onclick="CancelAddFriend('{{ Auth::user()->id }}','{{ $UserView->id }}')"><i class="glyphicon glyphicon-option-horizontal"></i> Requesting Add friend</a>
                     <a href="#" id="Addfriend" class="btn btn-default" style="display:none;" onclick="addfriend('{{ Auth::user()->id }}','{{ $UserView->id }}')"><i class="glyphicon glyphicon-plus"></i> Add friend</a>
