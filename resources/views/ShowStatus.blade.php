...
if($users == '[]'){ ?>
  <div class="panel panel-default" style=" border:0px; background-color:#111;">
    <div class="panel-body" style="background-color:#222; border:0px;"  align="center">
      <img src="{{ asset('public\logoweb.png') }}" alt="" width="75%">
      <h1 style="color:#999;">Wellcome to Managelife</h1>
      <h2 style="color:#999;">{{ Auth::user()->name }}</h2>
    </div>
  </div>
  <hr>
  <div class="panel panel-default" style=" border:0px; background-color:#111;">
    <div class="panel-body" style="background-color:#111; border:0px;"  align="center">
      ...
      <h1 style="color:#999;">Hey {{ Auth::user()->name }} you no status!</h1>
      <h2 style="color:#999;">You need to "Post status"</h2>
    </div>
  </div>
<?php
}else{
      ...
      <div class="panel-heading border-radius-top-20px2" style="background-color:#cc9900;">
        <div class="" style="position:absolute; right:20px;">
          ...
          <a href="{{ url('/home') }}" class="btnMenulife" style="color:#000;">
            <img class="img-circle" style="{{ Auth::user()->filter }}" src="{{ Auth::user()->avatar }}" width="60px">
            <label for="" style="font-size:18px;">{{ Auth::user()->name }}</label>
          </a>
